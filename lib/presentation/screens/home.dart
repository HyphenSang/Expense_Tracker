...
import 'package:expenses/presentation/widgets/home_header.dart';
...
import 'package:expenses/presentation/widgets/bank_account.dart';
import 'package:expenses/presentation/widgets/recent_transactions.dart';
import 'package:expenses/presentation/widgets/bottom_nav.dart';
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ReminderBanner(
                      message: 'Hũ "Tự do tài chính" của bạn đang ở mức thấp. Hãy cố gắng tiết kiệm thêm 2,000,000 ₫ trong tháng này!',
                    ),
                    const SizedBox(height: AppSpacing.xl),
